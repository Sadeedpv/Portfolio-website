...
function Card() {
  return (
    ...
    <div className='card-grid'>
        <CardItem size='large' plan='Basic' money='10,000' delay='0.4'
        a1='A static single page website'
        a2='HTML,CSS and JAVASCRIPT'
        a3='Free hosting on Github'
        a4='No backend'/>

        <CardItem size='normal' plan='Standard' money='15,000' delay='0.6'
        a1='Multipage websites'
        a2='Stunning visuals and animations'
        a3='Free hosting on Github'
        a4='No backend'/>

        <CardItem size='normal' plan='Premium' money='25,000' delay='0.8'
