  ...
  return (
    ...
    <motion.div className='intro'>
        <h1><motion.span className='hey'  initial={{opacity:'0%'}} animate={{opacity:'100%'}} transition={{delay:'0.8', duration:'2'}}>Hello,</motion.span> <br />
         I'm <motion.span className='name'  initial={{opacity:'0%'}} animate={{opacity:'100%'}} transition={{delay:'1.6', duration:'2'}}>&#60;Mohd Sadeed /&#62;</motion.span></h1>
...
<motion.div className='pic' initial={{x:'100%'}} animate={{x:'0%'}} transition={{delay:'0.5', duration:'1.2', type:'spring',damping:'30', stiffness:'100'}}><img src={blob}></img></motion.div>
</div>
  )
}
