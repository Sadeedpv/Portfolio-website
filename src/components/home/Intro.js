  ...
  return (
    ...
    <motion.div className='intro'>
        <h1><motion.span className='hey'  initial={{opacity:'0%'}} animate={{opacity:'100%'}} transition={{delay:'0.8', duration:'2'}}>Hello,</motion.span> <br />
         ...
         >&#60;<TypeAnimation cursor={true} speed={10000} sequence={['Mohd Sadeed', 3000, '', 1000, 'A Developer', 3000, '', 3000]} repeat={Infinity} className='block'></TypeAnimation>  /&#62;</motion.span></h1>
...
<motion.div className='pic' initial={{x:'100%'}} animate={{x:'0%'}} transition={{delay:'1.6', duration:'1.2', type:'spring',damping:'30', stiffness:'100'}}><img src={blob}></img></motion.div>
</div>
  )
}
