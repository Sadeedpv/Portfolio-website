...
function About(props) {
  ...
  return (
    <div className="about" id="about">
      <img src={props.first? cursor: cursor2} alt={props.first?'Do nothing and feel great!': 'Create Your own Mark'} style={{display:'none', position:'absolute', zIndex:'999999'}} ref={scrollImg}/>
      <hr />
