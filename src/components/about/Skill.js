...
function Skill() {
  return (
    <div className='skill-grid'>
        <Skillitem name={<FaUmbrella className='icon-fa'/>} title='Scalable Software' desc='I write scalable, secure and fast programs in languages like Python and javascript' delay='0.2'/>
